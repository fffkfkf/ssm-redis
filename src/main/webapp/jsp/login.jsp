...
<script type="text/javascript">
	...
	function changeImg(t) {
		t.src="${pageContext.request.contextPath}/code?"+new Date().getTime();
	}
	
	$(function(){
		//获取cookie的值
		var v=$.cookie('remember');
		//alert(v)
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        ...
        <label>
          <input type="checkbox" name="remember"  value="ok"   ${ cookie.remember==null?"":"checked='checked'"} > 记住用户名
        </label>
      </div>
    </div>
  </div>
